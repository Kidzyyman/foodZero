...
export class ModalReservationWindow {
  constructor() {
    ...
    this.modalReservation = new Modal(document.getElementById('modal-reservation'))
    this.successfullyMessage = document.getElementById('reservation-successfully')
  ...
  bindEventListeners() {
    this.reservationButton.addEventListener('click', this.handleReservationButtonClick.bind(this))
