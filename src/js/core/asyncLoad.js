...
class HtmlLoader {
	loadSections() {
		...
		sectionsHtml.addSection('preloader-page', 'preloadPage.html')
		sectionsHtml.addSection('header-container', 'header.html')
		sectionsHtml.addSection('hero-container', 'hero.html')
		sectionsHtml.addSection(
			'modal-reservation-container',
			'../../html/ui/reservation-form.html'
		)
		sectionsHtml.addSection('our-menu-container', 'ourMenu.html')
		sectionsHtml.addSection('excellent-cook-container', 'excellentCook.html')
		sectionsHtml.addSection(
			'post-excellent-cook-container',
			'post-excellentCook.html'
		)
	}
}
